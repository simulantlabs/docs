...
A **dataset** is a source of real-world signal that grounds the personas in your workspace. Datasets live under **Library → Datasets**. Simulant ships with a public library so you can start immediately, and you can add your own data to sharpen the population around your market.
