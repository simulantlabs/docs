...
<Frame caption="Grounding in practice — a cohort is built by toggling named source datasets, and the preview shows a real, data-backed respondent.">
  <img src="/images/app/cohort-builder.png" alt="Cohort builder showing official source datasets and a grounded sample respondent with vote intention" />
</Frame>
...
- A [cohort](/guides/cohorts) records which datasets it's built from.
- A [test](/guides/tests) records the cohort, the sample, and the real-world context of the run.
