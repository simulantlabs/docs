...
<Steps>
  ...
  <Step title="Tests, polls, and focus groups collect the reaction">
    A **test** runs a structured study across the whole cohort. A **poll** fields a short questionnaire to a panel drawn from the cohort — vote intention, approval, top issues — with no creative involved. A **focus group** convenes a small room from the cohort to deliberate in conversation.
  </Step>
</Steps>
...
| **Poll** | A fielded questionnaire returning weighted shares | **Polls** |
